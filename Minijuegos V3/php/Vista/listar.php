  ...
  <body>
    ...
    <table>
      ...
      <?php
          ...
          $rutaIconos = "../../Imagenes/Iconos";
          if (isset($filas)) {
              foreach ($filas as $indice) {
                $dir = opendir($rutaIconos);
                $elemento = $indice['icono'];
                foreach(scandir($rutaIconos) as $fichero)
                {
                    if($indice["icono"] == $fichero)
                    {
                      echo "
                              <tr>
                                  <td>".$indice['nombre']."</td>
                                  <td>
                                    <a href='#' class='enlacesImagenes'>".$indice['icono']."</a>
                                    <div class='divImagenes'>
                                      <img class='imagenesListar' src='".$rutaIconos."/".$fichero."'>
                                    </div>
                                  </td>
                                  <td>".$indice['ruta']."</td>
                                  <td>
                                    <a href=../Controlador/controlador.php?click=modificar&idMini=".$indice['idMinijuego'].">
                                      <img src='../../Imagenes/editar.png'>
                                    </a>
                                  </td>
                                  <td>
                                    <a href=../Controlador/controlador.php?click=borrar&idMini=".$indice['idMinijuego'].">
